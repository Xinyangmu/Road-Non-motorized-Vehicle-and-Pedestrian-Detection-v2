...
import sys
sys.path.append("/root/v8/ultralytics-main/")
...
def val(cfg=DEFAULT_CFG, use_python=False):
    ...
    model = './runs/segment/train/weights/best.pt' # cfg.model or 'yolov8m-seg.pt' # #
    data = cfg.data or 'coco.yaml'
    
    args = dict(model=model, data=data,cfg=cfg)
    print(args)
    if use_python:
